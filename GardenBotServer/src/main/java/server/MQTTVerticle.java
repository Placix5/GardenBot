...
public class MQTTVerticle extends AbstractVerticle{
	...
	//Canales
	public static final String TOPIC_SENSOR = "sensor"; //Obtendremos el valor de los sensores
	public static final String TOPIC_START = "start"; //Inicio manual del riego
	public static final String TOPIC_STOP = "stop"; //Parada manual del riego
